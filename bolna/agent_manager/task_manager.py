    ...
    async def __execute_function_call(self, url, method, param, api_token, model_args, meta_info, next_step, called_fun, **resp):
        ...
        if called_fun.startswith("transfer_call"):
            ...
            if url is None:
                ...
                payload = {'call_sid': call_sid, "agent_id": agent_id, "user_id": user_id, 'provider': self.tools["input"].io_provider, 'stream_sid': self.stream_sid, 'from_number': from_number, "execution_id":self.run_id_ts}
