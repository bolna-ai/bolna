...
_PROVIDER_PROMPT_CONFIG = {
    ...
    "cartesia": [
        ...
        },
        {
            ...
            "usage": "Spell out letter by letter. Use ONLY for email addresses, IDs, and course codes. Do NOT use for phone numbers.",
            "correct": "Email [spell]admissions@bit.edu[/spell]. Code [spell]CSE-401[/spell].",
            "wrong": "Email A D M I S S I O N S at B I T dot E D U.",
        },
    ],
}
